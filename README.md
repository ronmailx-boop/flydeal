...
- כפתור "תצוגת כרטיסים" מחליף את הטבלה בכרטיסי דילים (יעד, חברת תעופה
  בשם מלא, תאריכים ומחיר), בעיצוב בגווני הלוגו של FlyDeal.
- לצד כל מחיר בדולר מוצג גם מחיר משוער בשקלים, לפי שער החליפין היומי
  (נשלף מ-[Frankfurter](https://www.frankfurter.app/) בכל סריקה).
